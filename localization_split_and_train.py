...
cytoplasm_trigram = Trigram_Model(data_split,alphabet)
...
nucleus_trigram = Trigram_Model(data_split,alphabet)
...
extracellular_trigram = Trigram_Model(data_split,alphabet)
...
cellmembrane_trigram = Trigram_Model(data_split,alphabet)
...
mitochondrion_trigram = Trigram_Model(data_split,alphabet)
...
plastid_trigram = Trigram_Model(data_split,alphabet)
...
endoplasmicreticulum_trigram = Trigram_Model(data_split,alphabet)
...
lysosome_vacuole_trigram = Trigram_Model(data_split,alphabet)
...
golgi_apparatus_trigram = Trigram_Model(data_split,alphabet)
...
peroxisome_trigram = Trigram_Model(data_split,alphabet)
